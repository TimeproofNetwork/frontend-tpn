...
const TOKENS = [
  { name: "TimexloofNetvv0rks", symbol: "TPNZ" },       // ✅ Root token (symbol length >3 triggers LSIC)
  { name: "TimexloofNetvvorks", symbol: "TPNZ" },       // ✅ LSIC → removed '0'
  { name: "TimexloofNettv0rks", symbol: "TPNZ" },       // ✅ LSIC → doubled 't'
  { name: "TimexloofNetv0rks", symbol: "TPNZ" },        // ✅ LSIC → typo 'vv' vs 'v'
  { name: "TimexloofNetvv0rk", symbol: "TPNZ" },        // ✅ LSIC → dropped 's'
  { name: "TimexloofNetvv0rkz", symbol: "TPNZ" }        // ✅ LSIC → added 'z'
];
