...
const TOKENS = [
  { name: "TimeprufNertwok", symbol: "TNPXI" },       // ✅ Root token (LSIC: symbol >3)
  { name: "TimeprufNertw0k", symbol: "TNPXI" },        // ✅ LSIC → 'o' → '0'
  { name: "TimeprufNertwoek", symbol: "TNPXI" },       // ✅ LSIC → extra 'e'
  { name: "TimepruffNertwok", symbol: "TNPXI" },       // ✅ LSIC → doubled 'f'
  { name: "TimeprufNertwoks", symbol: "TNPXI" },       // ✅ LSIC → added 's'
  { name: "TimeprufNertwoqk", symbol: "TNPXI" },       // ✅ LSIC → typo 'q' for 'k'
  { name: "TimepruffNertwoqk", symbol: "TNPXI" }       // ✅ LSIC → doubled 'f' + typo
];
